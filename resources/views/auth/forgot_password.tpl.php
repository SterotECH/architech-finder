            ...
            <form action="/auth/forgot-password" method="POST" class="px-4 py-5 sm:p-6">
                <div class="grid grid-cols-1 gap-y-6">
                    <div>
                        ...
                        <input type="email" name="email" id="email" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="<?= $_POST['email'] ?? '' ?>" required />
                    </div>
