...
<section class="bg-gray-100 flex items-center justify-center h-screen">
    <div class="bg-white rounded-lg shadow-lg overflow-hidden sm:w-[500px]">
        <div class="px-4 py-5 sm:px-6">
            ...
            <p class="mt-1 max-w-2xl text-sm text-sky-500">
        ...
        <div class="border-t border-gray-200">
            ...
            <?php endif; ?>
            <form action="/auth/reset-password/<?= $token ?>" method="POST" class="px-4 py-5 sm:p-6">
                <?= csrf_field() ?>
                <div class="grid grid-cols-1 gap-y-6">
                    <div>
                        <label for="password" class="block text-sm font-medium text-gray-700">Password</label>
                        <input type="password" name="password" id="password" class="input" minlength="8" required />
                    </div>
                   <div>
                       <label for="password" class="block text-sm font-medium text-gray-700">Password</label>
                       <input type="password" name="password_confirmation" id="password" class="input" minlength="8" required />
                   </div>
                </div>
                <div class="mt-6">
                ...
                <p class="text-sm text-gray-600 mt-4">Remember Password? <a href="/auth/login" class="text-indigo-600">Sign In</a></p>
            </form>
        </div>
    </div>
</section>
