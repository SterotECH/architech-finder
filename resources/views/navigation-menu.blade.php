<nav x-data="{ open: false }" class="bg-white dark:bg-slate-800 border-b border-slate-100 dark:border-slate-700">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                        <x-heroicon-o-home class="size-6 mr-2 me-2 text-indigo-800 dark:text-indigo-200" />
                        {{ __('Dashboard') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('projects.index') }}" :active="request()->routeIs('projects.*')">
                        <x-heroicon-o-folder-open class="size-6 mr-2 me-2 text-indigo-800 dark:text-indigo-200" />
                        {{ __('Project') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('architects.index') }}" :active="request()->routeIs('architects.*')">
                        <x-heroicon-o-user-group class="size-6 mr-2 me-2 text-indigo-800 dark:text-indigo-200" />
                        {{ __('Architects') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('messages.index') }}" :active="request()->routeIs('messages.*')">
                        <x-heroicon-o-chat-bubble-left-right class="size-6 mr-2 me-2 text-indigo-800 dark:text-indigo-200" />
                        {{ __('Messages') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('architects.index') }}" :active="request()->routeIs('architects.*')">
                {{ __('Architects') }}
            </x-responsive-nav-link>
