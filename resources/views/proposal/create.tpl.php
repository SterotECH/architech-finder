  ...
  <div class="p-4 sm:p-6 space-y-4 sm:space-y-6">
    ...
    <div class="flex flex-col lg:flex-row gap-6">
      <div class="bg-white border shadow-sm rounded-xl p-4 w-full">
        <form action="/projects/<?= $project->slug ?>/proposals" method="POST" x-data="{ milestones: [
    ...
    { title: 'Construction Administration', description: 'Overseeing the construction process to ensure it aligns with the design intent, contract documents, and ensuring quality control.' }
          ...
          <div class="mb-4">
            ...
            <div class="relative pl-8">
              ...
              <button type="button" class="btn btn-secondary" @click="milestones.push({title: '', description: ''})">Add Milestone</button>
            </div>
          </div>

          <input type="hidden" name="milestones" x-model="JSON.stringify(milestones)">
