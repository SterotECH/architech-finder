  ...
  <div class="p-4 sm:p-6 space-y-4 sm:space-y-6">
    <div class="container mx-auto p-6">
      <div class="bg-white rounded-lg shadow-md p-6">
        <h1 class="text-2xl font-bold mb-4">Architect: {{ $architect->name }}</h1>
        <div class="mb-4">
          <span class="text-gray-700 font-bold">Email: </span>
          <span class="text-gray-900">{{ $architect->email }}</span>
        </div>
        <div class="mb-4">
          <span class="text-gray-700 font-bold">Phone Number: </span>
          <span class="text-gray-900">{{ $architect->phone_number }}</span>
        </div>
        <div class="mb-4">
          <span class="text-gray-700 font-bold">Gender: </span>
          <span class="text-gray-900">{{ $architect->gender }}</span>
        </div>
        <div class="mb-4">
          <span class="text-gray-700 font-bold">Location: </span>
          <span class="text-gray-900">{{ $architect->location }}</span>
        </div>
        <div class="mb-4">
